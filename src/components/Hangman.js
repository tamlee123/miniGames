...
function Hangman(props) {
  const instruction = [
    ...
    "If the letter you guessed is not in the word, a part of the body will appear in the diagram. If the body becomes completed, you are 'hanged' which means you have lost.",
